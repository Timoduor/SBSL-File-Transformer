...

        {
            ...
            try
            {
                ...
                if (inputFile != sanitizedFileName)
                {
                    ...
                    newFilePath = newFilePath.Replace(Path.GetFileNameWithoutExtension(newFilePath), Path.GetFileNameWithoutExtension(newFilePath) + "_" + DateTime.Now.ToString("ddMMMyyyy"));
                                        ...
                                        else
                                        {
                                            ...
                                            if (i + 4 < lines.Length)
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    if (GetColumnCount(line) == targetColumnCount)
                                                    {
                                                        if (lines[i + 6].Split('|').Length > 1 && (i + 6 < lines.Length))
                                                        {
                                                            i = i + 5;
                                                            reorderedLines.Add(line.Replace("\"", "").Replace("|", ","));
                                                        }
