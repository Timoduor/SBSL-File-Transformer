            ...
            for (var i = 4; i < list3.Count - 1; i++)
            {
                if (scontentl3 == "")
                {
                    if (list3[i].Col0.Trim() != "" && (list3[i].Col0.Trim() != "NET POSITION") && (list3[i].Col0.Trim() != "OPENING POSITION") && (list3[i].Col0.Trim() != "OPENING BALANCE") && (list3[i].Col0.Trim() != "TOTAL P/L") && (list3[i].Col0.Trim() != "O/N LIMIT IN USD") && (list3[i].Col0.Trim() != "D/L LIMIT IN USD") && (list3[i].Col0.Trim() != "TOTAL P&L") && (list3[i].Col0.Trim() != "CUST P&L") && (list3[i].Col0.Trim() != "INTERBANK P&L") && (list3[i].Col0.Trim() != "CUST P&L (BEFORE REVAL)"))
                        scontentl3 += list3[i].Col0.Trim() + "," + list3[i].Col1 + "," + list3[i].Col2 + "," + list3[i].Col3 + "," + list3[i].Col4 + "," + list3[i].Col5 + "," + list3[i].Col6 + "," + list3[i].Col7 + "," + list3[i].Col8 + "," + list3[i].Col9 + "," + list3[i].Col10 + "," + list3[i].Col11 + "," + list3[i].Col12 + "," + list3[i].Col13 + "," + list3[i].Col14 + "," + list3[i].Col15 + "," + list3[i].Col16 + "," + list3[i].Col17 + "," + list3[i].Col18 + "," + list3[i].Col19 + "," + list2[i].Col20 + Environment.NewLine;
