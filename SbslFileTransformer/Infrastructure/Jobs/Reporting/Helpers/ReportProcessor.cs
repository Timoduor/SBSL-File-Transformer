            ...
            foreach (var report in processed)
            {
                try
                {
                    ...
                    await emailSender.SendMessage(recipients, emailSubject,
                                                        ...
                                                        Environment.NewLine +
                                                        $"Report Name {report.OriginalReport.Name.ToUpper()}" + Environment.NewLine +
                                                        $"Report generated by: {report.OriginalReport.Creator.ToUpper()}" + Environment.NewLine +
                                                        $"NOTES:- {report.OriginalReport.Notes}", false, attachment);
