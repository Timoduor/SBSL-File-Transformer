...
namespace SbslFileTransformer.Infrastructure.Jobs.Extractors
{
    public class MpesaBalanceExtractorJob : ConverterJobBase<MpesaBalanceExtractorJob>, IHostedService
    {
        ...
        public Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            this._timer = new Timer(async state => await this.MpesaFileBalanceExtractor(), null,
        ...
        private async Task MpesaFileBalanceExtractor()
        {
            try
            {
                ...
                this._logger.LogInformation("Running MPesa Balance Extractor job");
                ...
                using (IServiceScope scope = this._serviceScopeFactory.CreateScope())
                {
                    ...
                    MpesaBalanceExtractor mpesaConverter = new MpesaBalanceExtractor();
