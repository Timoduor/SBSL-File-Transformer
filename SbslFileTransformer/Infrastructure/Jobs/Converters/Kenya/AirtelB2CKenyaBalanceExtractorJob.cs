...
{
    public class AirtelB2CKenyaBalanceExtractorJob : ConverterJobBase<AirtelB2CKenyaBalanceExtractorJob>, IHostedService
    {
        public AirtelB2CKenyaBalanceExtractorJob(ILogger<AirtelB2CKenyaBalanceExtractorJob> logger,
        ...
        protected override string JobName { get; set; } = nameof(AirtelB2CKenyaBalanceExtractorJob);

        public Task StartAsync(CancellationToken cancellationToken)
        {
            this._logger.LogInformation("Starting Airtel B2C Balance Extractor Job");
        ...
        private async Task AirtelFileBalanceExtractor()
        {
            try
            {
                ...
                this._logger.LogInformation("Running Airtel B2C Balance Extractor job");
                ...
                using (IServiceScope scope = this._serviceScopeFactory.CreateScope())
                {
                    ...
                    var mpesaConverter = new AirtelB2CKenyaBalanceExtractor();
                    ...
                    foreach (string file in files)
                    {
                            ...
                            file.ToLower().Contains("banking") && file.ToLower().Contains("imke"))
                        {
                            ...
                            if (fileToProcess != null && fileToProcess.Converted == false)
                                ...
                                {
                                    this.CompleteFileProcessing(updatedFiles, fileToProcess, nameof(AirtelB2CKenyaBalanceExtractor), true);
                                }
                        }
                    }
