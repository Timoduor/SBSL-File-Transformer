        ...
        private async Task MoneyGramConverter()
        {
            try
            {
                ...
                using (IServiceScope scope = _serviceScopeFactory.CreateScope())
                {
                    ...
                    MoneyGramActivityKEConverter mpesaConverter = new MoneyGramActivityKEConverter(_logger);
                    ...
                    foreach (string file in files)
                    {
                            ...
                            file.ToLower().Contains("imke") && !file.Contains("Conv"))
                        {
                            ...
                            if (fileToProcess != null && fileToProcess.Converted == false)
                                ...
                                {
                                    CompleteFileProcessing(updatedFiles, fileToProcess, nameof(MoneyGramActivityKEConverter));
                                }
                        }
                    }
