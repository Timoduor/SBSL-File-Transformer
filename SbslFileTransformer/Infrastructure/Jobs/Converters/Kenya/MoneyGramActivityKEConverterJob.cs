...
namespace SbslFileTransformer.Infrastructure.Jobs.Converters.Kenya
{
    ...
    {
        public MoneyGramActivityKEConverterJob(ILogger<MoneyGramActivityKEConverterJob> logger, IServiceScopeFactory serviceScopeFactory, EmailSender emailSender)
        {
            _logger = logger;
            ...
            try
            {
                ...
                using (var scope = _serviceScopeFactory.CreateScope())
                {
                    ...
                    foreach (var file in files)
                    {
                        ...
                        if (file.ToLower().Contains("moneygram") && file.ToLower().Contains("activity") && file.ToLower().Contains("imke") && !file.Contains("Conv"))
                        {
                            ...
                            if (fileToProcess != null && fileToProcess.Converted == false)
                            {
                                ...
                                finally
                                {
                                    ...
                                    fileToProcess.ConvertedBy = nameof(MoneyGramActivityKEConverter);
