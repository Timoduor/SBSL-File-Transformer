...
namespace SbslFileTransformer.Infrastructure.Jobs.Converters.Kenya
{
    public class PesaLinkGl2ConverterJob : ConverterJobBase<PesaLinkGl2ConverterJob>, IHostedService
    {
        ...
        public Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            _timer = new Timer(async state => await PesalinkJobConverter(), null,
        ...
        private async Task PesalinkJobConverter()
        {
            try
            {
                ...
                _logger.LogInformation("Running Pesa Link GL2 Converter job");
                ...
                using (IServiceScope scope = _serviceScopeFactory.CreateScope())
                {
                    ...
                    PesaLinkConverter mpesaConverter = new PesaLinkConverter();
