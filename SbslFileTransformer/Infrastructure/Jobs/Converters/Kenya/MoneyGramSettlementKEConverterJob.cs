...
namespace SbslFileTransformer.Infrastructure.Jobs.Converters.Kenya
{
    ...
    {
        protected override string JobName { get; set; } = nameof(MoneyGramSettlementKEConverterJob);
        ...
        private async Task MoneyGramConverter()
        {
            try
            {
                ...
                using (IServiceScope scope = this._serviceScopeFactory.CreateScope())
                {
                    ...
                    MoneyGramSettlementKEConverter mpesaConverter = new MoneyGramSettlementKEConverter(this._logger);
