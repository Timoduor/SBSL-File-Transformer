...
{
    public class MoneyGramActivityUGConverterJob : ConverterJobBase<MoneyGramActivityUGConverterJob>, IHostedService
    {
        protected override string JobName { get; set; } = nameof(MoneyGramActivityUGConverterJob);
        public MoneyGramActivityUGConverterJob(ILogger<MoneyGramActivityUGConverterJob> logger,
        ...
        {
            this._logger.LogInformation("Starting UG MoneyGram Activity Converter Job");
        ...
        private async Task MoneyGramConverter()
        {
            try
            {
                ...
                this._logger.LogInformation("Running UG MoneyGram Activity Converter Job");
                ...
                using (IServiceScope scope = this._serviceScopeFactory.CreateScope())
                {
                    ...
                    foreach (string file in files)
                    {
                        ...
                        if (file.ToLower().Contains("moneygram") && file.ToLower().Contains("activity") &&
