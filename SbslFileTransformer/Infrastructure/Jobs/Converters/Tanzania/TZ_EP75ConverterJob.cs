...
namespace SbslFileTransformer.Infrastructure.Jobs.Converters
{
    public class TZ_EP75ConverterJob : ConverterJobBase<TZ_EP75ConverterJob>, IHostedService
    {
        ...
        {
            _logger.LogInformation("Starting TZ EP75 Converter Job");

            _semaphore = new SemaphoreSlim(1, 1);

            _timer = new Timer(async state => await ConvertEP75File(), null,
                TimeSpan.FromSeconds(new Random().Next(10, 35)), TimeSpan.FromMinutes(10));
        ...
        private async Task ConvertEP75File()
        {
            try
            {
                ...
                _logger.LogInformation("Running TZ EP75 converter job");
                ...
                using (var scope = _serviceScopeFactory.CreateScope())
                {
                    ...
                    var tzepinConverter = new Tz_EP75Converter();
                            ...
                            file.ToLower().Contains("cards"))
                        {
                            ...
                            if (fileToProcess != null && fileToProcess.Converted == false)
                                ...
                                catch (Exception ex)
                                {
                                    ...
                                    await EmailHelpers.SendEmails(dbContext, "Problem Converting TZ EP75 files",
                                ...
                                finally
                                {
                                    ...
                                    fileToProcess.ConvertedBy = nameof(TZ_EP75ConverterJob);
