...
namespace SbslFileTransformer.Infrastructure.Jobs.Converters.Tanzania
{
    public class FxRatesTzConverterJob : ConverterJobBase<FxRatesTzConverterJob>, IHostedService
    {
        ...
        {
            this._logger.LogInformation("Starting FX Rates Converter TZ Job");

            _semaphore = new SemaphoreSlim(1, 1);

            this._timer = new Timer(async state => await this.FxRatesConverter(), null,
        ...
        private async Task FxRatesConverter()
        {
            try
            {
                ...
                this._logger.LogInformation("Running FX Rates Converter TZ job");
                ...
                using (IServiceScope scope = this._serviceScopeFactory.CreateScope())
                {
                    ...
                    FxRatesTZConverter mt300Converter = new FxRatesTZConverter();
                    ...
                    foreach (string file in files)
                    {
                            ...
                            !file.Contains("Conv"))
                        {
                            ...
                            if (fileToProcess != null && fileToProcess.Converted == false)
                                ...
                                {
                                    this.CompleteFileProcessing(updatedFiles, fileToProcess, nameof(FxRatesTZConverter));
                                }
                        }
                    }
