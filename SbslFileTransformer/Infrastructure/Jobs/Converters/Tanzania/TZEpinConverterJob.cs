...
namespace SbslFileTransformer.Infrastructure.Jobs.Converters
{
    public class TZEpinConverterJob : ConverterJobBase<TZEpinConverterJob>, IHostedService
    {
        ...
        {
            _logger.LogInformation("Starting TZ EPIN Converter Job");
        ...
        private async Task ConvertEPINFile()
        {
            try
            {
                ...
                using (var scope = _serviceScopeFactory.CreateScope())
                {
                    ...
                    var tzepinConverter = new TzEpinConverter();
                        ...
                        if (file.ToLower().Contains("epin") && file.ToLower().Contains("imtz") && file.ToLower().Contains("cards"))
                        {
                            ...
                            if (fileToProcess != null && fileToProcess.Converted == false)
                                ...
                                catch (Exception ex)
                                {
                                    ...
                                    await EmailHelpers.SendEmails(dbContext, "Problem Converting TZ EPIN files",
