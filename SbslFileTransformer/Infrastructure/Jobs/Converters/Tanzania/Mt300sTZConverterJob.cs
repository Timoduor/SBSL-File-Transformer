...
namespace SbslFileTransformer.Infrastructure.Jobs.Converters.Tanzania
{
    public class Mt300sTZConverterJob : ConverterJobBase<Mt300sTZConverterJob>, IHostedService
    {
        ...
        {
            this._logger.LogInformation("Starting MT300s Converter TZ Job");
        ...
        private async Task MT300sConverter()
        {
            try
            {
                ...
                this._logger.LogInformation("Running MT300s Converter TZ job");
                    ...
                    foreach (string file in files)
                    {
                            ...
                            !file.Contains("Conv"))
                        {
                            ...
                            if (fileToProcess != null && fileToProcess.Converted == false)
                                ...
                                {
                                    this.CompleteFileProcessing(updatedFiles, fileToProcess, nameof(Mt300sTZConverterJob));
                                }
                        }
                    }
