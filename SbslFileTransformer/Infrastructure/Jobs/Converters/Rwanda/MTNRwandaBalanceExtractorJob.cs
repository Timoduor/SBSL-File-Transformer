        ...
        private async Task AirtelFileBalanceExtractor()
        {
            try
            {
                ...
                using (var scope = _serviceScopeFactory.CreateScope())
                {
                    ...
                    {
                        if (file.ToLower().Contains("mb") && file.ToLower().Contains("imrw") && file.ToLower().Contains("mtn") && file.ToLower().Contains("vtu") && file.ToLower().Contains("airtime") && file.ToLower().Contains("portal"))
                        {
