...
namespace SbslFileTransformer.Infrastructure.Jobs.Converters.Rwanda
{
    public class MTNRwandaBalanceExtractorJob : ConverterJobBase<MTNRwandaBalanceExtractorJob>, IHostedService
    {
        ...
        {
            this._logger.LogInformation("Starting MTN RW Balance Extractor Job");
        ...
        private async Task AirtelFileBalanceExtractor()
        {
            try
            {
                ...
                this._logger.LogInformation("Running MTN RW Balance Extractor job");
                ...
                using (IServiceScope scope = this._serviceScopeFactory.CreateScope())
                {
                    ...
                    MTNRwandaBalanceExtractor mpesaConverter = new MTNRwandaBalanceExtractor(Entity);
                    ...
                    foreach (string file in files)
                    {
                            ...
                            file.ToLower().Contains("airtime") && file.ToLower().Contains("portal"))
                        {
                            ...
                            if (fileToProcess != null && fileToProcess.Converted == false)
                                ...
                                {
                                    this.CompleteFileProcessing(updatedFiles, fileToProcess, nameof(MTNRwandaBalanceExtractor));
                                }
                        }
                    }
