        ...
        private async Task MoneyGramConverter()
        {
            try
            {
                ...
                using (IServiceScope scope = this._serviceScopeFactory.CreateScope())
                {
                    ...
                    AdviceKopeduRWConverter mpesaConverter = new AdviceKopeduRWConverter();
                    ...
                    foreach (string file in files)
                    {
                        ...
                        if (file.ToLower().Contains("wu") && file.ToLower().Contains("portal") &&
                            file.ToLower().Contains("advice") && file.ToLower().Contains("imrw") &&
                            !file.Contains("Conv"))
                        {
                            ...
                            if (fileToProcess != null && fileToProcess.Converted == false)
                                ...
                                {
                                    this.CompleteFileProcessing(updatedFiles, fileToProcess, nameof(AdviceKopeduRWConverter));
                                }
                        }
                    }
