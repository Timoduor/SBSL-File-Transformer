...
namespace SbslFileTransformer.Infrastructure.Jobs.Converters
{
    ...
    {
        public BnrSettlementConverterJob(ILogger<BnrSettlementConverterJob> logger, IServiceScopeFactory serviceScopeFactory, EmailSender emailSender)
        {
            _logger = logger;
        ...
        private async Task ConvertBnrFile()
        {
            try
            {
                ...
                using (var scope = _serviceScopeFactory.CreateScope())
                {
                    ...
                    {
                        if (file.ToLower().Contains("bnr") && file.ToLower().Contains("imrw") && file.ToLower().Contains("settlements"))
                        {
                            ...
                            if (fileToProcess != null && fileToProcess.Converted == false)
                            {
                                ...
                                finally
                                {
                                    ...
                                    fileToProcess.ConvertedBy = nameof(SettlementConverter);
