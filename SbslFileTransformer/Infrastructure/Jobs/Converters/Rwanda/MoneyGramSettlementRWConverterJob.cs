...
namespace SbslFileTransformer.Infrastructure.Jobs.Converters.Rwanda
{
    ...
    {
        protected override string JobName { get; set; } = nameof(MoneyGramSettlementRWConverterJob);
        public MoneyGramSettlementRWConverterJob(ILogger<MoneyGramSettlementRWConverterJob> logger,
        ...
        private async Task MoneyGramConverter()
        {
            try
            {
                ...
                this._logger.LogInformation("Running MoneyGram SettlementRW  Converter job");
                ...
                using (IServiceScope scope = this._serviceScopeFactory.CreateScope())
                {
                    ...
                    foreach (string file in files)
                    {
                        ...
                        if (file.ToLower().Contains("mg") && file.ToLower().Contains("settlement") &&
                            file.ToLower().Contains("imrw") && !file.Contains("Conv"))
                        {
                            ...
                            if (fileToProcess != null && fileToProcess.Converted == false)
                                ...
                                {
                                    this.CompleteFileProcessing(updatedFiles, fileToProcess, nameof(MoneyGramSettlementRWConverter));
                                }
                        }
                    }
