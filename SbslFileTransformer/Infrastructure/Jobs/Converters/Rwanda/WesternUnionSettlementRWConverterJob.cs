        ...
        IHostedService
    {
        ...
        private async Task WesternUnionSettlementConverter()
        {
            try
            {
                ...
                this._logger.LogInformation("Running Western Union Settlement RW job");
                    ...
                    foreach (string file in files)
                    {
                            ...
                            file.ToLower().Contains("portal"))
                        {
                            ...
                            if (fileToProcess != null && fileToProcess.Converted == false)
                                ...
                                {
                                    this.CompleteFileProcessing(updatedFiles, fileToProcess, nameof(WesternUnionSettlementRWConverter));
                                }
                        }
                    }
