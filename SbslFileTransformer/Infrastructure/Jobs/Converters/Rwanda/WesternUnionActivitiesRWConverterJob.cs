...
namespace SbslFileTransformer.Infrastructure.Jobs.Converters.Rwanda
{
        ...
        IHostedService
    {
        ...
        {
            this._logger.LogInformation("Starting Western Union RW Activities Job");
        ...
        private async Task WesternUnionActivitiesConverter()
        {
            try
            {
                ...
                this._logger.LogInformation("Running Western Union RW Activities job");
                ...
                using (IServiceScope scope = this._serviceScopeFactory.CreateScope())
                {
                    ...
                    WesternUnionActivitiesRWConverter westernUnionConverter = new WesternUnionActivitiesRWConverter();
                    ...
                    foreach (string file in files)
                    {
                            ...
                            file.ToLower().Contains("portal"))
                        {
                            ...
                            if (fileToProcess != null && fileToProcess.Converted == false)
                                ...
                                {
                                    this.CompleteFileProcessing(updatedFiles, fileToProcess, nameof(WesternUnionActivitiesRWConverter));
                                }
                        }
