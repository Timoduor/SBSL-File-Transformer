...
namespace SbslFileTransformer.Infrastructure.Jobs.Converters.Kenya
{
        ...
        IHostedService
    {
        ...
        {
            _logger.LogInformation("Starting Western Union RW Activities Job");
        ...
        private async Task WesternUnionActivitiesConverter()
        {
            try
            {
                ...
                _logger.LogInformation("Running Western Union RW Activities job");
                    ...
                    foreach (string file in files)
                    {
                            ...
                            file.ToLower().Contains("portal"))
                        {
                            ...
                            if (fileToProcess != null && fileToProcess.Converted == false)
                                ...
                                {
                                    CompleteFileProcessing(updatedFiles, fileToProcess, nameof(WesternUnionActivitiesRWConverter));
                                }
                        }
